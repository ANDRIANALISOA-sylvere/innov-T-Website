...
export default function Footer() {
  ...
  return (
    <footer
      ref={ref}
      className={`relative text-white px-6 pt-12 pb-4 transition-all duration-1000 ease-out ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {["react", "java", "python", "node"].map((tech, i) => (
                <div key={i} className="flex items-center justify-center">
                  <img
                    src={`/images/techs/${tech}.png`}
                    alt={tech}
