    ...
    <section className="py-20 bg-white px-6">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 text-left">
          <h3
            className="text-2xl font-bold bg-gradient-to-r from-blue-800 via-green-600 to-green-500 bg-clip-text text-transparent mb-3"
          >
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mt-12">
        <button className="px-8 py-3 cursor-pointer bg-blue-900 hover:bg-blue-800 text-white rounded-full font-semibold transition">
          Découvrir nos projets
        </button>
        <button className="px-8 py-3 cursor-pointer bg-green-600 hover:bg-green-700 text-white rounded-full font-semibold transition">
          Je veux une équipe
        </button>
      </div>
    </section>
